...
public class popUp14 : MonoBehaviour
{
    ...
    void TaskOnClick()
    {
        if (game == 1) 
        {
            ...
            gm14.currentWord += GetComponent<TextMesh>().text;
            ...
            gm14.selectLetter[gm14.letterNum] = GetComponent<TextMesh>().text;
            Debug.Log("Count = " + gm14.count);
            Debug.Log(game);
        }
    }
}